"""Log compression for Experiment 2, with several selectable strengths so
Experiment 2 can measure an actual compression-vs-retention trade-off curve
instead of a single "compressed or not" data point.
...
with a faithful port and update this note (and the report's methodology
section) accordingly.
