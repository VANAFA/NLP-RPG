...
const initialState: GameState = {
  ...
  activeNpc: null,
  objective: 'Survive and find out what happened in this place.',
  worldNotes: [],
};
  ...
  const startNewGame = async () => {
    ...
    try {
      ...
      setChat([
        ...
        { role: 'Narrator', story: character.story, thinking: '[INTERNAL SYSTEM]\nCharacter generated by the Game Master.' },
      ]);
    } catch (error) {
      ...
      setChat([
        { role: 'SYSTEM', text: 'C:\\> SYSTEM INITIALIZED. AI LINK ESTABLISHED.' },
        { role: 'SYSTEM', text: '[SYSTEM] Could not generate a character via the LLM (did you configure ⚙ LINK?). Using the default character.' },
        { role: 'Narrator', story: 'You wake up in a dark room. What do you do?', thinking: '[INTERNAL SYSTEM]\nStarting wake-up sequence.' },
      ]);
    } finally {
