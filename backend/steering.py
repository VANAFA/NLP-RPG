...
Shared verbatim with experiments/steering.py, which is where this method
was validated (see experiments/paper/noob_paper_en.tex) before being wired
into this live server.
"""
...
def get_decoder_layers(model) -> torch.nn.ModuleList:
    ...
    both shapes are used by this server (base vs. LoRA-adapted model)."""
    for accessor in (
